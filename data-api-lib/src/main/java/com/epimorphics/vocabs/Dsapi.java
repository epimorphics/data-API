 ...
 * @author Auto-generated by schemagen on 24 Aug 2017 12:31 
 */
public class Dsapi {
    ...
    /** <p>Indicates that the type given as object has values that are (typed) literals.</p> */
    public static final Property literalType = m_model.createProperty( "http://www.epimorphics.com/public/vocabulary/dsapi#literalType" );
    ...
    /** <p>controls whether modifiers are applied to the inner (default) or outer (legacy) 
     *  SELECTs of the generated query.</p>
     */
    public static final Property modifiers = m_model.createProperty( "http://www.epimorphics.com/public/vocabulary/dsapi#modifiers" );
    ...
    /** <p>value for modifiers to be attached to inner SELECT."</p> */
    public static final Resource inner = m_model.createResource( "http://www.epimorphics.com/public/vocabulary/dsapi#inner" );
    
    /** <p>value for modifiers to be attached to outer SELECT.</p> */
    public static final Resource outer = m_model.createResource( "http://www.epimorphics.com/public/vocabulary/dsapi#outer" );
